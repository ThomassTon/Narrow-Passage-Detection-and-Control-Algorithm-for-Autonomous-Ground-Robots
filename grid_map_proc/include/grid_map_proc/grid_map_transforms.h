...
namespace grid_map_transforms{
    ...
    bool addExplorationTransform(grid_map::GridMap& grid_map,
                            ...
                            const float penalty_weight = 1.0,   //const float penalty_weight = 1.0,
                            const std::string occupancy_layer = "occupancy",
                            const std::string dist_trans_layer = "distance_transform",
    ...
    bool addExplorationTransform_narrow(grid_map::GridMap& grid_map,
                            const std::vector<grid_map::Index>& goal_points,
                            float lethal_dist = 3.5,
                            float penalty_dist = 5.5,
                            float penalty_weight =0,   //const float penalty_weight = 1.0,
                            const std::string occupancy_layer = "occupancy",
                            const std::string dist_trans_layer = "distance_transform",
                            const std::string expl_trans_layer = "exploration_transform");
    ...
    void touchExplorationCell_narrow(const grid_map::Matrix& grid_map,
                              const grid_map::Matrix& dist_map,
                         grid_map::Matrix& expl_trans_map,
                         const int idx_x,
                         const int idx_y,
    ...
    void touchExplorationCell_narrow_2(const grid_map::Matrix& grid_map,
                              const grid_map::Matrix& dist_map,
                         grid_map::Matrix& expl_trans_map,
                         const int idx_x,
                         const int idx_y,
